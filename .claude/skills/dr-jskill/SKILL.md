...
1. Java 21 installed
2. Node.js 20.x and NPM 10.x (for front-end development)
3. Docker installed and running
4. MySQL 8.0 (or MariaDB 11)
...
1. Use the latest Spring Boot version (currently 3.x) - the `create-project-latest.mjs` script automatically fetches it
2. **Review Spring Boot 3 critical considerations**: See [Spring Boot 3 Migration Guide](references/SPRING-BOOT-3.md) for Jackson 2 annotations and TestContainers configuration
3. Include Spring Boot Actuator for production-ready features
4. Use Spring Data JPA for database access
5. Use MySQL 8.0 (or MariaDB 11) for database - see [Database Best Practices](references/DATABASE.md) for optimization
...
## Azure Deployment (Disabled - Coming Soon)

> Cloud deployment is temporarily disabled. Azure deployment support will be added in a future update.
...
**Core Spring Boot:**
- [Spring Boot 3 Migration Guide](references/SPRING-BOOT-3.md) - Key changes from Spring Boot 2, Jackson 2 annotations
