...
export function getBootFallback() { return getVersionValue('springBootFallback', '3.4.3'); }
export function getMysqlVersion() { return getVersionValue('mysqlVersion', '8.0'); }
export function getMariadbVersion() { return getVersionValue('mariadbVersion', '11'); }
...
export function getNodeVersion() { return getVersionValue('nodeVersion', '20.18.0'); }
export function getNpmVersion() { return getVersionValue('npmVersion', '10.9.0'); }
export function getViteVersion() { return getVersionValue('viteVersion', '6'); }
